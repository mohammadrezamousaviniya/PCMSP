! function (t, e) {
    ...
    return h.listen = function (t, e) {
        ...
        defaultMessage: "اطلاعات وارد شده صحیح نمیباشد.",
        type: {
            email: "ایمیل آدرس اشتباه وارد شده است.",
            url: "لطفا آدرس الکترونیکی درست را وارد نمایید.",
            number: "تمامی مشخضات وارد شده میبایستی عدد باشند.",
            integer: "This value should be a valid integer.",
            digits: "This value should be digits.",
            alphanum: "This value should be alphanumeric."
        },
        notblank: "این مقدار نبایستی که خالی باشد.",
        required: "پر کردن این فیلد ضروری است",
        pattern: "This value seems to be invalid.",
        min: "مقدار وارد شده میبایستی کوچکتر یا مساوی %s باشد.",
